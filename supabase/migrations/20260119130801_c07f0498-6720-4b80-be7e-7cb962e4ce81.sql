-- Fix accept_quiz_invitation function: add difficulty::quiz_difficulty cast
...
BEGIN
  ...
  -- Create the battle using 'friend' mode
  -- CRITICAL FIX: Cast difficulty from text to quiz_difficulty enum
