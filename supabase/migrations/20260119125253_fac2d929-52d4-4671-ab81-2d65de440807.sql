-- Fix accept_quiz_invitation function to use valid enum value 'friend' instead of 'multiplayer'
...
BEGIN
  ...
  -- Create the battle using 'friend' mode (valid enum value)
  INSERT INTO quiz_battles (
    mode, status, subject_id, grade_level, difficulty, created_by
  ) VALUES (
    'friend', 'waiting'::quiz_battle_status, v_invitation.subject_id, 
