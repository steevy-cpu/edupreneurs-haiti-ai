...
DROP POLICY IF EXISTS "Group creators can add initial members" ON public.group_members;
...
CREATE POLICY "delete_group_members_admin"
ON public.group_members
FOR DELETE
TO authenticated
USING (public.is_group_admin(auth.uid(), group_id));

CREATE POLICY "delete_group_members_self"
ON public.group_members
FOR DELETE
TO authenticated
