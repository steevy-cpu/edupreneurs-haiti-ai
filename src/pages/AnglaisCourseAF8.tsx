...
const AnglaisCourseAF8 = () => {
  ...
  const monthColors: Record<string, string> = {
    'Décembre': 'from-blue-500 to-cyan-600',
    'Janvier': 'from-cyan-500 to-teal-600',
    'Février': 'from-purple-500 to-pink-600',
    'Mars': 'from-pink-500 to-rose-600',
    'Avril': 'from-green-500 to-emerald-600',
    'Mai': 'from-emerald-500 to-teal-600',
    'Juin': 'from-amber-500 to-orange-600'
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 mb-6 shadow-lg">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Programme complet d'anglais pour la 8ème année fondamentale
          </p>
        </div>
                      ...
                      <Card
                        ...
                        onClick={() => {
                          if (lesson.is_published) {
                            navigate(`/anglais-af8-lesson/${lesson.slug}`);
                          } else {
                            toast({
...
export default AnglaisCourseAF8;
