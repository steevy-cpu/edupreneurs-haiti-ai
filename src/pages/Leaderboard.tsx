...
const Leaderboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      {/* Header */}
      <div className="bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--success))] text-white p-6 sm:p-8 relative overflow-hidden">
          ...
          <div className="space-y-3">
            {leaderboard.map((user) => {
              ...
              return (
                <Card
                  key={user.id}
                  className={`border-none rounded-[20px] shadow-md transition-all hover:scale-[1.02] ${
                    isCurrentUser ? "ring-2 ring-primary" : ""
                  }`}
                >
                  <CardContent
                    className={`p-4 bg-gradient-to-r ${getRankBgColor(user.rank)} border`}
                  >
                    <div className="flex items-center gap-4">
                      {/* Rank */}
                      ...
                      <Avatar className="h-12 w-12">
                        <AvatarFallback className="bg-gradient-to-br from-primary/20 to-success/20 font-semibold">
