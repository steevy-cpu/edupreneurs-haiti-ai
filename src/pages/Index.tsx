        ...
        <div className="container mx-auto">
          ...
          <div className="text-center mt-10">
            ...
            <div className="flex justify-center gap-4">
              <a href="https://facebook.com/edupreneurs" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#1877F2] flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer shadow-lg">
              ...
              <a href="https://instagram.com/edupreneurs" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer shadow-lg">
              ...
              <a href="https://tiktok.com/@edupreneurs" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-black flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer shadow-lg">
