  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href={`https://mon-edupreneur.com/templates/edit/${template.slug}`} />
        <link rel="alternate" hrefLang="fr-HT" href={`https://mon-edupreneur.com/templates/edit/${template.slug}`} />
        <link rel="alternate" hrefLang="fr" href={`https://mon-edupreneur.com/templates/edit/${template.slug}`} />
