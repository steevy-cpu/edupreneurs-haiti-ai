...
import { ArrowLeft, BookOpen, Clock, Award, Beaker } from "lucide-react";
                      ...
                      <Card
                        ...
                        onClick={() => {
                          if (lesson.is_published) {
                            navigate(`/sciences-af8-lesson/${lesson.slug}`);
                          } else {
                            toast({
...
export default SciencesCourseAF8;