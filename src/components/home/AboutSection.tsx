 ...
 * Desktop: fade + slide-up columns on scroll.
    ...
    <section id="about" className="relative py-20 px-4 bg-gradient-to-br from-background to-accent/5 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {/* Left Column - Mission — fade-up on desktop */}
          <MotionDiv
            className="space-y-6"
            {...(shouldAnimate ? { initial: "hidden", animate: isInView ? "visible" : "hidden", variants: sectionVariants } : {})}
          >
          ...
          {/* Right Column - Vision — fade-up with slight delay on desktop */}
          <MotionDiv
            {...(shouldAnimate ? {
              initial: "hidden",
          ...
          >
            <Card className={`relative bg-gradient-to-br from-card via-primary/5 to-accent/10 shadow-xl border-2 border-primary/20 overflow-hidden group transition-all duration-500 ease-out h-full ${
