...
// Settings Page Skeleton - with simplified option for 3G
export const SettingsPageSkeleton = ({ simplified = false }: { simplified?: boolean }) => (
  <div className="pt-20 px-4 sm:px-6 lg:px-8 pb-24 max-w-7xl mx-auto">
    ...
    {simplified ? (
      ...
      /* Full skeleton for fast connections */
      <>
...
// Matieres Grid Skeleton for 3G optimization
export const MatieresGridSkeleton = ({ count = 6 }: { count?: number }) => (
...
// Dashboard Full Skeleton for auth checking state
